...
Route::group(['prefix' => 'secure', 'middleware' => 'web'], function () {
    ...
    Route::post('billing/subscriptions/bitcoin/agreement/create', 'Common\Billing\Gateways\Bitcoin\BitcoinController@createSubscriptionAgreement');
    Route::post('billing/subscriptions/bitcoin/agreement/execute', 'Common\Billing\Gateways\Bitcoin\BitcoinController@executeSubscriptionAgreement');
    Route::post('billing/subscriptions/bitcoin/agreement/check', 'Common\Billing\Gateways\Bitcoin\BitcoinController@checkPaymentStatus');
    ...
    // FREE SUBSCRIPTIONS
    Route::post('billing/subscriptions/free/agreement/create', 'Common\Billing\Subscriptions\SubscriptionsController@freeStore');
...
// BITCOIN
Route::get('billing/bitcoin/callback/approved', 'Common\Billing\Gateways\Bitcoin\BitcoinController@approvedCallback');
Route::get('billing/bitcoin/callback/canceled', 'Common\Billing\Gateways\Bitcoin\BitcoinController@canceledCallback');
Route::get('billing/bitcoin/loading', 'Common\Billing\Gateways\Bitcoin\BitcoinController@loadingPopup');
...
Route::post('billing/bitcoin/webhook', 'Common\Billing\Gateways\Bitcoin\BitcoinWebhookController@handleWebhook');
